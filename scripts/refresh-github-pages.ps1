...
try {
    ...
    $withdrawalCount = Assert-Export $tempWithdrawal 'credit_pass_date' @('credit_pass_date','risk_level','product','platform','credit_limit_bucket','credit_pass_customer_cnt','credit_pass_limit_amt_sum','t0_withdraw_numerator','t7_withdraw_numerator','t0_withdraw_utilization_denominator')
